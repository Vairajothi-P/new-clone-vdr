...
export default function WatermarkPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#F8FAFC]">
      ...
      {showPreviewModal && (
        <div className="fixed inset-0 bg-black/80 z-[100] flex items-center justify-center p-4 md:p-10 backdrop-blur-md" style={{ animation: 'fadeIn 0.3s ease-out' }}>
          <div className="relative w-full max-w-3xl h-full flex flex-col">
            ...
            {/* A4 Document */}
            <div className="flex-1 overflow-auto flex justify-center rounded-2xl bg-slate-800/50 p-6 md:p-10 border border-white/5">
              <div className="w-full max-w-[680px] bg-white rounded-lg shadow-2xl overflow-hidden flex flex-col" style={{ minHeight: '960px', aspectRatio: '210 / 297' }}>
                {/* Doc Toolbar */}
          ...
          <div className="lg:col-span-5 flex flex-col">
            <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-200 p-6 flex-1 flex flex-col">
              ...
              <div className="relative flex-1 min-h-[420px] bg-slate-100 rounded-2xl border border-slate-200 overflow-hidden flex flex-col p-4 shadow-inner">
                {/* Toolbar */}
                <div className="bg-white/80 backdrop-blur-md border border-slate-200/80 rounded-xl px-4 py-2 flex items-center justify-between mb-4 shadow-sm z-20">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full bg-red-400" />
                    <div className="w-3 h-3 rounded-full bg-yellow-400" />
                    <div className="w-3 h-3 rounded-full bg-green-400" />

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[var(--brand)]/10 via-white to-[var(--brand-secondary)]/10 flex flex-col items-center justify-center p-4 sm:p-6 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md">
        ...
        {/* Card */}
        <div className="bg-white/95 rounded-3xl shadow-2xl p-6 sm:p-8 md:p-10 backdrop-blur-xl border border-gray-100/90 relative overflow-hidden transition-all duration-300">
          ...
          {isSuccess ? (
            ...
            <div>
              ...
              <div className="flex flex-col items-center justify-center gap-2 mb-6 text-center">
                <div className="w-14 h-14 rounded-2xl brand-gradient flex items-center justify-center shadow-lg shadow-[var(--brand)]/25 transition-transform hover:scale-105 duration-300">
                  <FiShield
              ...
              {resendToast && (
                <div className="mb-5 p-3.5 bg-emerald-50/90 border border-emerald-200 text-emerald-900 rounded-2xl flex items-center gap-2.5 text-xs sm:text-sm font-medium shadow-xs animate-in fade-in slide-in-from-top-2 duration-300">
              ...
              {errorMsg && (
                <div className="mb-5 p-3.5 bg-rose-50 border border-rose-200 text-rose-800 rounded-2xl flex items-start gap-2.5 text-xs sm:text-sm font-medium animate-in fade-in duration-200">
              ...
              {isExpired && (
                <div className="mb-5 p-3.5 bg-amber-50 border border-amber-200 text-amber-900 rounded-2xl flex items-center justify-between gap-3 text-xs sm:text-sm font-medium animate-in fade-in duration-200">
              ...
              <form onSubmit={handleVerify}>
                  ...
                  <div className="flex items-center justify-between gap-1.5 sm:gap-2.5">
                    {otp.map((digit, index) => (
                      <input
                        ...
                        className={`w-11 h-13 sm:w-13 sm:h-16 text-xl sm:text-2xl font-extrabold text-center rounded-2xl border transition-all duration-200 focus:outline-none ${
                          isExpired
                ...
                <button
                  ...
                  className="w-full py-3.5 sm:py-4 bg-[var(--brand)] hover:bg-[var(--brand-dark)] text-white font-bold rounded-2xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none flex items-center justify-center gap-2.5 shadow-lg shadow-[var(--brand)]/25 hover:shadow-xl hover:shadow-[var(--brand)]/30 active:scale-[0.99] cursor-pointer text-sm sm:text-base"
                >
                  {isVerifying ? (
                    <>
        ...
        {isChangeEmailOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-xs animate-in fade-in duration-200">
            <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-7 max-w-sm w-full border border-gray-100 animate-in zoom-in-95 duration-200">
        ...
        {/* Demo Helper Footer */}
        <div className="mt-6 p-4 rounded-2xl bg-white/75 backdrop-blur-md border border-gray-200/60 shadow-xs max-w-md w-full text-center">

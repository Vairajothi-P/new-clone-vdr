...
export default function WorkspaceSettingPage() {
  ...
  return (
    <div className="flex h-screen bg-slate-50 relative overflow-hidden">
      ...
      <aside className={`fixed md:relative top-0 left-0 h-screen w-20 bg-white/90 backdrop-blur-xl border-r border-gray-200/80 flex flex-col items-center py-6 shrink-0 z-50 shadow-[4px_0_24px_rgba(28,127,159,0.06)] transform transition-transform duration-300 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
        ...
        <div className="flex flex-col items-center mt-auto relative mb-4">
          ...
          >
            <FaPowerOff size={18} />
            <span className="absolute left-16 bg-slate-800 text-white text-xs font-semibold px-3 py-1.5 rounded-lg opacity-0 pointer-events-none group-hover:opacity-100 group-hover:translate-x-1 transition-all duration-300 whitespace-nowrap shadow-xl z-50">
              Exit
            </span>
          </button>
        </div>

...
export default function FolderActivityPage() {
    ...
    return (
        <div className="p-8 bg-white min-h-full font-sans">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
                    ...
                    <div className="relative flex flex-col gap-1">
                        ...
                        {isFolderDropdownOpen && (
                            <div className="absolute top-full left-0 mt-1 w-full bg-white border border-gray-200 shadow-xl rounded-lg z-50 max-h-48 overflow-y-auto divide-y divide-gray-100">
                                <div
            ...
            {/* Table Section */}
            <div className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden shadow-sm">
                {/* Table Header */}
                <div className="grid grid-cols-6 gap-4 px-5 py-3.5 bg-gray-50 text-gray-700 font-semibold border-b border-gray-200 text-xs">
                    <div
                ...
                <div className="flex flex-col relative min-h-[250px]">
                    {isLoading ? (
                        ...
                        currentDisplayedFolders.map((folder, index) => (
                            <div
                                key={folder.id}
                                className={`grid grid-cols-6 gap-4 px-5 py-3.5 border-b border-gray-100 items-center ${index % 2 === 0 ? 'bg-slate-50/50' : 'bg-white'}`}
                            >
                                <div className="text-gray-900 font-medium truncate pr-4 text-xs" title={folder.name}>{folder.name}</div>
                                <div
                                    className="text-orange-600 underline cursor-pointer hover:text-orange-800 font-medium text-xs"
                                    onClick={() => handleOpenModal(folder, 'view')}
                                >
                                    {folder.viewCount}
                                </div>
                                <div className="text-gray-700 font-mono text-xs flex items-center gap-1">
                                ...
                                <div
                                    className="text-gray-900 underline cursor-pointer hover:text-black font-bold text-xs"
                ...
                {/* Pagination */}
                <div className="flex items-center justify-between px-5 py-3.5 bg-gray-50 border-t border-gray-200 text-xs text-gray-500">
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-slate-50">
                            <div>
                                <h2 className="text-[15px] font-bold text-gray-900">Folder Activity Audit Log</h2>
                                <p className="text-[12px] text-gray-500 mt-0.5">
                                    {selectedFolder?.name} &middot; <span className="font-semibold text-orange-600">{modalData.length} records</span>
                                </p>
                            </div>
                            <button
                                onClick={() => setShowModal(false)}

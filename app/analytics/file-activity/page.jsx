                ...
                <div className="flex flex-col relative min-h-[250px]">
                    {isLoading ? (
                        ...
                        currentDisplayedFiles.map((file, index) => (
                            ...
                            >
                                <div className="text-gray-900 font-medium truncate pr-4 text-xs" title={file.name}>{file.name}</div>
                                <div
                        ...
                        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-slate-50">
                            <div>
                                ...
                                <p className="text-[12px] text-gray-500 mt-0.5">
                                    {selectedFile?.name} &middot; <span className="font-semibold text-orange-600">{getModalCount()} activities</span>
                                </p>
                            </div>
                            <button
                                onClick={() => setShowModal(false)}

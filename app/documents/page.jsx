                ...
                <Modal onClose={() => setIsUploadModalOpen(false)}>
                    ...
                    <div className="flex gap-4 mb-4">
                        <button onClick={() => fileInputRef.current?.click()}
                            className="flex-1 flex flex-col items-center justify-center gap-3 p-6 border-2 border-dashed border-slate-200 bg-slate-50 rounded-2xl hover:border-slate-400 hover:bg-slate-100 transition-all">
                        ...
                        <button onClick={() => folderInputRef.current?.click()}
                            className="flex-1 flex flex-col items-center justify-center gap-3 p-6 border-2 border-dashed border-amber-200 bg-amber-50 rounded-2xl hover:border-amber-400 hover:bg-amber-100 transition-all">
                ...
                <Modal onClose={() => setIsDownloadChoiceOpen(false)} maxWidth="max-w-sm">
                    ...
                    <div className="flex gap-4">
                        <button onClick={() => { setIsDownloadChoiceOpen(false); executeDownload('original'); }}
                            className="flex-1 flex flex-col items-center justify-center gap-3 p-6 border border-slate-200 bg-slate-50 rounded-2xl hover:border-slate-400 hover:bg-slate-100 transition-all">
                            <div className="w-10 h-10 rounded-xl bg-slate-900 flex items-center justify-center">
                        ...
                        <button onClick={() => { setIsDownloadChoiceOpen(false); executeDownload('encrypted'); }}
                            className="flex-1 flex flex-col items-center justify-center gap-3 p-6 border border-slate-200 bg-slate-50 rounded-2xl hover:border-emerald-400 hover:bg-emerald-50 transition-all">
...
function Modal({ children, onClose, maxWidth = 'max-w-lg' }) {
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className={`relative bg-white rounded-2xl border border-slate-200 shadow-2xl w-full ${maxWidth} p-6 z-10`}>
                {children}
            </div>
        </div>
    );
...
//                     <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4 p-4 bg-white border border-slate-200/60 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.015)]">
...
//                 {isNewFolderOpen && (
//                     <form onSubmit={handleCreateFolderSubmit} className="flex items-center gap-3 p-4 bg-slate-50/80 border border-slate-200/80 rounded-2xl mb-4">
...
//                 {/* Main Files Table */}
//                 <div className="flex-1 overflow-auto mt-2 rounded-2xl border border-slate-200 bg-white shadow-[0_4px_25px_rgba(0,0,0,0.015)]">
...
//             {isUploadModalOpen && (
//                 <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
//                     <div onClick={() => setIsUploadModalOpen(false)} className="absolute inset-0 bg-slate-900/50 backdrop-blur-[2px]"></div>
//                     <div className="relative bg-white rounded-3xl border border-slate-200 shadow-2xl w-full max-w-3xl p-8 z-10">
//                         <h3 className="text-[17px] font-extrabold text-slate-850 mb-6">Secure Upload Center</h3>
//                         <div onClick={triggerFileSelect} className="flex flex-col items-center justify-center p-8 border-2 border-dashed border-slate-200 bg-slate-50 rounded-2xl cursor-pointer">
...
//                         className="flex items-center gap-3 p-4 bg-slate-50/80 border border-slate-200/80 rounded-2xl mb-4 animate-in fade-in slide-in-from-top-2 duration-300"
//                     >
...
//                     <div onClick={() => { if (uploadQueue.length === 0) setIsUploadModalOpen(false); }} className="absolute inset-0 bg-slate-900/50 backdrop-blur-[2px] animate-in fade-in duration-300"></div>

//                     <div className="relative bg-white/95 backdrop-blur-md rounded-3xl border border-slate-200/80 shadow-2xl w-full max-w-3xl overflow-hidden flex flex-col md:flex-row animate-in zoom-in-95 slide-in-from-bottom-8 duration-300">
...
//                                         {uploadQueue.map(item => (
//                                             <div key={item.id} className="p-3 bg-slate-50 border border-slate-200 rounded-2xl flex items-center justify-between gap-4">
...
//                                 /* Drag Zone */
//                                 <div className="space-y-4">
//                                     <div onClick={triggerFileSelect} className="flex flex-col items-center justify-center p-8 border-2 border-dashed border-slate-200 hover:border-slate-400 bg-gradient-to-br from-slate-50 to-slate-100/50 hover:bg-slate-100/30 rounded-2xl cursor-pointer transition-all duration-300 group">
//                                         <div className="w-12 h-12 bg-white shadow border border-slate-200/80 text-slate-600 rounded-2xl flex items-center justify-center mb-3 group-hover:scale-105 transition-transform duration-300">
...
//             {isDeleteModalOpen && (
//                 <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
//                     <div onClick={() => setIsDeleteModalOpen(false)} className="absolute inset-0 bg-slate-900/50 backdrop-blur-[2px] animate-in fade-in duration-300"></div>
//                     <div className="relative bg-white/95 backdrop-blur-md rounded-3xl border border-slate-200/80 shadow-2xl w-full max-w-md overflow-hidden p-6 md:p-8 animate-in zoom-in-95 slide-in-from-bottom-8 duration-300 select-none">
//                         <div className="w-12 h-12 bg-rose-50 border border-rose-100 rounded-2xl flex items-center justify-center text-rose-600 mb-5">
...
//             {isDownloadModalOpen && (
//                 <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
//                     <div className="absolute inset-0 bg-slate-900/50 backdrop-blur-[2px] animate-in fade-in duration-300"></div>
//                     <div className="relative bg-white/95 backdrop-blur-md rounded-3xl border border-slate-200/80 shadow-2xl w-full max-w-sm overflow-hidden p-6 md:p-8 animate-in zoom-in-95 slide-in-from-bottom-8 duration-300 select-none">
//                         <div className="flex flex-col items-center text-center">
//                             <div className="w-12 h-12 bg-indigo-50 border border-indigo-100 rounded-2xl flex items-center justify-center text-indigo-600 mb-5 relative">
...
//             {isExportModalOpen && (
//                 <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
//                     <div onClick={() => setIsExportModalOpen(false)} className="absolute inset-0 bg-slate-900/50 backdrop-blur-[2px] animate-in fade-in duration-300"></div>
//                     <div className="relative bg-white/95 backdrop-blur-md rounded-3xl border border-slate-200/80 shadow-2xl w-full max-w-lg overflow-hidden flex flex-col md:flex-row animate-in zoom-in-95 slide-in-from-bottom-8 duration-300 select-none">
...
//                                 <div className="p-3.5 bg-white border border-slate-200 rounded-2xl shadow-inner break-all text-[11.5px] font-semibold text-slate-600 leading-relaxed font-mono select-all">
//                                     {exportSecureLink}
//                                 </div>

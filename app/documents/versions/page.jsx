...
import { FaHistory, FaDownload, FaHistory as FaRestore } from 'react-icons/fa';
...
export default function DocumentVersionsPage() {
    ...
    const handleRestore = async (versionId) => {
        if (!window.confirm("Are you sure you want to restore this version? The current version will be archived.")) return;
            ...
            {Object.keys(groupedVersions).length === 0 ? (
                ...
                <div className="space-y-6">
                    {Object.values(groupedVersions).map(group => (
                        <div key={group.document_id} className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                                                ...
                                                <td className="py-3 px-5 text-right">
                                                    <div className="flex items-center justify-end gap-3">
                                                        <button 
                                                            ...
                                                            className="text-slate-400 hover:text-purple-600 transition-colors disabled:opacity-50" 
                                                        ...
                                                        <button 
                                                            ...
                                                            className="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-slate-200 rounded-lg text-[12px] font-bold text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-all shadow-sm ml-2 disabled:opacity-50"
                                                        >
                                                            <FaRestore className="text-[11px]" />

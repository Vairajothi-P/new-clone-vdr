...
// // [KEEP YOUR PERMISSION_SECTIONS AND DEFAULT_PERMS EXACTLY THE SAME]
...
//     // ── HITS THE NEW PERMISSIONS API ──
//     useEffect(() => {
//         if (!showPermissionPage || !groupData || !session) return;
...
//         };
//         loadPerms();
//     }, [showPermissionPage, groupData, session]);
...
//             // Reload perms to get new existingIds
...
//     // [KEEP YOUR EXACT ORIGINAL UI RETURN BLOCK HERE]
//     return (
//         <div className="flex-1 flex flex-col h-screen overflow-hidden font-sans bg-[#F8FAFC] relative">
//             <div className="absolute top-0 left-0 w-full h-96 bg-gradient-to-b from-[var(--brand)]/10 to-transparent pointer-events-none transition-colors duration-500"></div>
...
//                                 {/* FILE ACCESS CARD — (UI Only, handled by documents page later) */}
//                                 {
//                                     (() => {

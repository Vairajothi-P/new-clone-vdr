...
//     const [inviteEmail, setInviteEmail] = useState("");
//     const [inviteDescription, setInviteDescription] = useState("");
//     const [requireNda, setRequireNda] = useState(true); // NEW: NDA State (Default to true)
//     const [inviting, setInviting] = useState(false);
...
//                     group_id: groupData?.id,
//                     invited_by: sessionData.id,
//                     requires_nda: requireNda // NEW: Send NDA Flag to API
//                 }),
//             });
...
//                             Invite a new member to join <span className="font-semibold text-slate-900">{loading ? "this group" : groupData?.name || "this group"}</span>. They will receive an email with a link to join.
//                         </p>
//                     </div>
...
//                                 </label>
//                                 <div className="relative">
//                                     <FaEnvelope size={14} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none" />
//                                     <input
//                                         type="email"
//                                         value={inviteEmail}
...
//                                         required
//                                         className="w-full bg-white border border-slate-200 rounded-xl pl-10 pr-4 py-3 text-sm font-medium text-slate-800 outline-none focus:border-[var(--brand)] focus:ring-2 focus:ring-[var(--brand)]/10 transition-all placeholder:text-slate-400"
//                                     />
//                                 </div>
//                             </div>
...
//                             <div>
//                                 <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">
//                                     Invitation Message <span className="text-slate-400 normal-case font-normal">(Optional)</span>
//                                 </label>
//                                 <textarea
...
//                                     className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-sm font-medium text-slate-800 outline-none focus:border-[var(--brand)] focus:ring-2 focus:ring-[var(--brand)]/10 resize-none transition-all placeholder:text-slate-400"
//                                 />
//                             </div>

//                             {/* NEW: NDA Requirement Toggle */}
//                             <div className="bg-slate-50 border border-slate-200 rounded-xl px-4 py-4 flex items-center justify-between">
//                                 <div className="flex items-center gap-3">
//                                     <div className="w-8 h-8 rounded-lg bg-blue-100 text-blue-600 flex items-center justify-center shrink-0">
//                                         <FaFileSignature size={14} />
...
//                                     <div>
//                                         <p className="text-sm font-bold text-slate-800">Require NDA Agreement</p>
//                                         <p className="text-xs text-slate-500 font-medium">Candidate must sign before joining.</p>
//                                     </div>
//                                 </div>
//                                 <label className="relative inline-flex items-center cursor-pointer">
//                                     <input

...
export default function BusinessOwnerPurchasePage() {
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-6 animate-in fade-in duration-500">
      <div className="bg-white border border-slate-200 rounded-3xl p-12 sm:p-16 text-center shadow-2xs max-w-md w-full">
        <div className="w-16 h-16 rounded-2xl bg-[var(--brand)]/10 text-[var(--brand)] flex items-center justify-center mx-auto mb-6">

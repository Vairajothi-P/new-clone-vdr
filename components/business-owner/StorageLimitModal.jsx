...
export default function StorageLimitModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-white border border-slate-200 rounded-2xl shadow-xl overflow-hidden z-10 transition-all">
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/70 space-y-2.5 text-sm">

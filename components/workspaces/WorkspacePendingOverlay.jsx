...
export default function WorkspacePendingOverlay({ companyName = "Your Organization" }) {
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-lg w-full p-8 text-center space-y-6 shadow-2xl animate-in zoom-in-95 duration-300">
